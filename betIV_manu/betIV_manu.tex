...
The \emph{Betaproteobacteria} are often the numerically dominant group in freshwater lakes \cite{Glockner2000}. Freshwater \emph{Betaproteobacteria} have been classified into seven broad monophyletic lineages based on 16s rRNA gene sequences \cite{Newton2011}, one of which exclusively contains freshwater members of the family \emph{Methylophilaceae} \cite{Newton2011}. Freshwater 16s rRNA gene sequences within the \emph{Methylophilaceae} fall into two clusters \cite{Newton2011}, known as LD28 (after a clone from Lake Loosdrecht in the Netherlands, \cite{Zwart2002) and PRD01a001B (after a clone from XXXXX). Members of the LD28 group are "typical" freshwater bacteria, showing both persistence and abundance across lakes in Europe \cite{Zwart2002, Zwart2003, Lindstrom2005, Parveen2011, Salcher2011a, Eiler2012} and Asia \cite{Wu2006}. The LD28 group is also closely related to the marine OM43 group of the \emph{Methylophilaceae} \cite{Giovannoni2008, Halsey2012}. Isolates of both LD28 and PRD01a001B have recently been obtained \cite{Salcher2015}, revealing these microbes to be psychrophilic methylotrophs with small cell sizes and streamlined genomes (<2 Mb). 

This publication describes one single-cell genome (SAG) and seven metagenome-assembled genomes (MAGs) for freshwater members of the \emph{Methylophilaceae} from two lakes in Wisconsin, United States. These genomes are part of two larger sequencing projects. Single-cell genomes were collected in 2009, and selected to represent common and abundant freshwater bacteria. Metagenomes were collected at numerous time-points from 2005 to 2013 as part of a long-term monitoring project under the auspices of the National Science Foundation's Long-Term Ecological Research program.  All genomes were sequenced and assembled through the United States Department of Energy's Joint Genome Institute (US-DoE-JGI). Metagenome-assembled genomes (MAGs) were also binned by the JGI.
